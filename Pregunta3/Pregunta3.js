...
function init() {
	...
	// var ma = new THREE.LineBasicMaterial( { color: 0x482103,linewidth:100 } );
	// var linea = new THREE.Geometry();
	// linea.vertices.push( new THREE.Vector3( -0.19, 0.15, 0.0 ) );
	// linea.vertices.push( new THREE.Vector3( -0.15, 0.09, 0.0 ) );
	// linea.vertices.push( new THREE.Vector3( 0.0, 0.09, 0.0 ) );
	// linea.vertices.push( new THREE.Vector3( 0.19, 0.15, 0.0 ) );
	// var mlinea=new THREE.Line(linea,ma);
	// mlinea.position.y=2.8;
	// mlinea.linewidth=10;
